...
class Unet(nn.Module):
    def __init__(self, n_classes=2):  # 默认为二分类问题，可以修改为任何n分类
        ...
        self.layer10_conv = nn.Conv2d(8, n_classes, kernel_size=3, stride=1, padding=1, bias=True)  # 修改输出层的通道数为n_classes
